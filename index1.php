...
//微信身份判定是否已经领取过优惠券
	...
	$giftdate=$giftRates[$targetTime];

	
	
	// $imgPath = "http://wcloud.wsestar.com/gree201609/img/";
...
<html lang="en">
	...
	<script type="text/javascript">
		...
		WXSettings.link='<?php echo URL_BASE; ?>index.php?inviter=<?=$userId?>';
		...
		function StartGetResult(){
			...
			AjaxPostNoWait(url,function(data, textStatus, jqXHR){
				console.log(data);
				// data = "1000";
